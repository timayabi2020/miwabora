...
class QuestionsPage extends StatefulWidget {
  ...
  _QuestionsPageState createState() =>
      _QuestionsPageState(this.userId.toString(), resultsMap);
}
      ...
      result.then((response) {
        if (response.statusCode == 200) {
          ...
          apiSuccessShowDialog(context,
              "Your question has successfully been raised. Please check your email for further instructions");
        } else {
