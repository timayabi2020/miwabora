...
class TraderRegistrationPage extends StatefulWidget {
  const TraderRegistrationPage({Key? key}) : super(key: key);

  @override
  _TraderRegistrationPageState createState() => _TraderRegistrationPageState();
}

class _TraderRegistrationPageState extends State<TraderRegistrationPage> {
